...
/**
 * @brief Also check if the user enters an inch value greater than a foot. If greater, then add to the original measurement in feet and inches. Return this value to the user. 
 * 
 * @param argc 
 * @param argv 
 * @return int 
