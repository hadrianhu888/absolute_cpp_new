...
double check_total_measurement_meters_centimeters(double meters, double centimeters) {
...
double metric_to_imperial(char choice) {
    ...
    switch (choice) {
        case '2':
            ...
            cin >> centimeters;
            total_inches = check_total_measurement_meters_centimeters(meters, centimeters);
